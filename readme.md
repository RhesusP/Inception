...
- Chaque image Docker doit obligatoirement porter le **même nom que le service concerné**
...
**👉 Les containers doivent redémarrer en cas de crash.**

### Users

Deux utilisateurs sont présents dans la base de données WordPress :
